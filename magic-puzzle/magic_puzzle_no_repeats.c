...
static void checkBL(int ai) {
  if (a[TL].i < a[BL].i && a[BL].i < a[TR].i) {
    actions[ai + 1].action(ai + 1);
  }
}
...
int main(int argc, const char* argv[]) {
  ...
  actions[++i].pos = 8; actions[i].action = &chooseBR;
  actions[++i].pos = 5; actions[i].action = &decide; actions[i].indexes[0] = 2; actions[i].indexes[1] = 8;
  actions[++i].pos = 4; actions[i].action = &decide; actions[i].indexes[0] = 0; actions[i].indexes[1] = 8;
  ...
  actions[++i].pos = 0; actions[i].action = &validate; actions[i].indexes[0] = 6; actions[i].indexes[1] = 7; actions[i].indexes[2] = 8;
