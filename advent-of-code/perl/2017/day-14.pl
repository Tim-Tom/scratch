...
Suddenly, a scheduled job activates the system's disk_defragmenter. Were the
situation different, you might sit_and_watch_it_for_a_while, but today, you
