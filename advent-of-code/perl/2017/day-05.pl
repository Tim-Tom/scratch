...
would be taken before an exit is found:
    * (0)Â 3Â Â 0Â Â 1Â Â -3Â  - before we have taken any steps.
    * (1)Â 3Â Â 0Â Â 1Â Â -3Â  - jump with offset 0 (that is, don't jump at
      all). Fortunately, the instruction is then incremented to 1.
    * Â 2Â (3)Â 0Â Â 1Â Â -3Â  - step forward because of the instruction we
      just modified. The first instruction is incremented again, now to 2.
    * Â 2Â Â 4Â Â 0Â Â 1Â (-3) - jump all the way to the end; leave a 4 behind.
    * Â 2Â (4)Â 0Â Â 1Â Â -2Â  - go back to where we just were; increment -3 to
      -2.
    * Â 2Â Â 5Â Â 0Â Â 1Â Â -2Â  - jump 4 steps forward, escaping the maze.
